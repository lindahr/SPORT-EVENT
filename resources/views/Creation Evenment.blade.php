    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="/Liste des evenments">Liste des evenment</a></li>
          <li ><a href="/Liste de salle">Liste de salle</a></li>
          <li class="menu-active"><a href="/Creation Evenment">Creation Evenment</a></li>
          ...
          <form action="" method="post" role="form" class="contactForm">
            <div class="form-row">
              ...
              <div class="form-group col-md-5">
                <input type="text" name="name" class="form-control" id="name_sale" placeholder="Nom de salle,club... " data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                <div class="validation"></div>
              </div>
              <div class="form-group col-md-1"></div>
              <div class="form-group col-md-5">
                <input type="text" name="name" class="form-control" id="nom_event" placeholder="Nom d'evénment" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                <div class="validation"></div>
              </div>

             <div class="form-group col-md-5">
                <input type="number" name="name" class="form-control" id="numéro" placeholder="Telephone" data-rule="minlen:4" data-msg="Please enter at least 7 number" />
                <div class="validation"></div>
              </div>
              <div class="form-group col-md-1"></div>
              <div class="form-group col-md-5">
                <input type="date" name="name" class="form-control" id="date" data-rule="minlen:4" data-msg="date exacte d'evénment" />
                <div class="validation"></div>
              </div>
            ...
            <div class="form-group col-md-5">
              ...
              <div class="form-group col-md-1"></div>
              <div class="form-group col-md-5">
                <input type="text" name="adresse" class="form-control" id="adresse" placeholder="Adresse d'événment" data-rule="minlen:4" data-msg="Please enter a valide adresse d'evénment" />
                <div class="validation"></div>
              </div>
            ...
            <div class="text-center"><button type="submit">Envoye </button></div>
          </form>
        </div>
