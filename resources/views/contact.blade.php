    ...
    <section id="contact" class="section-bg wow fadeInUp">
      <div class="container">
        ...
        <div class="section-header">
          <h3>Contact Us</h3>
          <p>Vous souhaitez nous contacter ? nous sommes toujours à votre écoute. Vous pouvez nous contacter directement par email, téléphone ou courrier.</p>
        </div>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Address</h3>
              <address class="address">E^pi , 4000 , Sousse</address>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:+216000000">+2162012012021</a></p>
            </div>
          </div>
