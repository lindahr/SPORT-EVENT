    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="/info">info</a></li>
...
<p> Suivez l'actualité sportive en direct - Tous les résultats, news et chroniques sportives en France et dans le monde sur le Football, Basketball, Cyclisme, Rugby ... </p>
...
<div class="container">
  ...
  <div class="col">
    ...
    <div class="card-container">
      ...
      <div class="overlay"></div>
      <div class="card">
        <h2>coupe d'afrique</h2>
        <span class"chev"><a href="#"></a>&rsaquo;</a></span>
      </div>
    </div>
  ...
  <div class="col">
    ...
    <div class="card-container">
      ...
      <div class="overlay"></div>
      <div class="card">
        <h2>5eim edition de tournoi de france de tennis</h2>
        <span class"chev">&rsaquo;</span>
      </div>
    </div>
  ...
  <div class="col">
    ...
    <div class="card-container">
      ...
      <div class="overlay"></div>
      <div class="card">
        <h2>ternois king boxing erlnda vs allmagne</h2>
        <span class"chev">&rsaquo;</span>
      </div>
    </div>
