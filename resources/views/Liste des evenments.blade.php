    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="/Liste des evenments">Liste des evenments</a></li>
...
<p> Suivez les evenments sportive en direct - Tous  news et chroniques sportives en France et dans le monde sur le Football, Basketball, Cyclisme, Rugby ... </p>

<div class="wrapper">
  
  <div class="cols">
      <div class="col-lg-2 col-md-3 portfolio-item filter-web wow fadeInUp" ontouchstart="this.classList.toggle('hover');" class="col">
        <div class="container">
          <div class="front" style="background-image: url('img/event/1.jpg')">
            <div class="inner">
              <p>GOLEF LIGUE</p>
          ...
          <div class="back">
            <div class="inner">
              <p>cette event est un organisation des ..... en jj/mm/aa .</p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-2 col-md-3 portfolio-item filter-web wow fadeInUp" ontouchstart="this.classList.toggle('hover');" class="col">
        <div class="container">
          <div class="front" style="background-image: url('img/event/2.jpg')">
            <div class="inner">
              <p>vélo 2008</p>
      ...
      <div class="col-lg-2 col-md-3 portfolio-item filter-web wow fadeInUp" ontouchstart="this.classList.toggle('hover');" class="col">
        <div class="container">
          <div class="front" style="background-image: url('img/event/3.jpg')">
            <div class="inner">
              <p>TENNIS CHOMPIONS </p>
      ...
      <div class="col-lg-2 col-md-3 portfolio-item filter-web wow fadeInUp" ontouchstart="this.classList.toggle('hover');" class="col">
        <div class="container">
          <div class="front" style="background-image: url('img/event/4.jpg')">
            <div class="inner">
              <p>coupe de monde</p>
      ...
      <div class="col-lg-2 col-md-3 portfolio-item filter-web wow fadeInUp" ontouchstart="this.classList.toggle('hover');" class="col">
        <div class="container">
          <div class="front" style="background-image: url('img/event/5.jpg')">
            <div class="inner">
              <p>SKI Technique</p>
      ...
      <div class="col-lg-2 col-md-3 portfolio-item filter-web wow fadeInUp" ontouchstart="this.classList.toggle('hover');" class="col">
        <div class="container">
          <div class="front" style="background-image: url('img/event/6.jpg')">
            <div class="inner">
              <p>COURS MONDIAL</p>
       ...
       <div class="col-lg-2 col-md-3 portfolio-item filter-web wow fadeInUp" ontouchstart="this.classList.toggle('hover');" class="col">
        <div class="container">
          <div class="front" style="background-image: url('img/event/7.jpg')">
            <div class="inner">
              <p>COURS TERMINAL</p>
      ...
      <div class="col-lg-2 col-md-3 portfolio-item filter-web wow fadeInUp" ontouchstart="this.classList.toggle('hover');" class="col">
        <div class="container">
          <div class="front" style="background-image: url('img/event/8.jpg')">
            <div class="inner">
              <p>TOURS DE FRANCE</p>
      ...
      <div class="col-lg-2 col-md-3 portfolio-item filter-web wow fadeInUp" ontouchstart="this.classList.toggle('hover');" class="col">
        <div class="container">
          <div class="front" style="background-image: url('img/event/9.jpg')">
            <div class="inner">
              <p>tour horse</p>
