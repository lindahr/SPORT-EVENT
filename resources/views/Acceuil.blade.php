...
<header id="header">
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active" ><a href="/Acceuil">Acceuil</a></li>
...
<div class="login">
          ...
          <form action="/login" method="doLogout" role="form" >
...
<div class="login-wrap">
  <div class="login-html">
    <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Se Connect</label>
    <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab"><a href="/inscrie">je m'inscris</a></label>
    <div class="login-form">
      <div class="sign-in-htm">
        <div class="group">
          <label for="user" class="label">Nom Utilisateur</label>
          <input id="user" type="text"  class="input">
        </div>
        <div class="group">
          <label for="pass" class="label">Mots de pass</label>
        ...
        <div class="group">
          <a href="/admi"><input type="submit" class="button" value=" CONNECT"></a>
        </div>
        <div class="hr"></div>
        <div class="foot-lnk">
